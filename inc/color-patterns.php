 ...
 */
function capezzahill_custom_colors_css() {
	$primary_color = 199;
	 ...
	 */
	$saturation = apply_filters( 'capezzahill_custom_colors_saturation', 100 );
	 ...
	 */
	$saturation_selection = absint( apply_filters( 'capezzahill_custom_colors_saturation_selection', 50 ) );
	 ...
	 */
	$lightness = apply_filters( 'capezzahill_custom_colors_lightness', 33 );
	 ...
	 */
	$lightness_hover = apply_filters( 'capezzahill_custom_colors_lightness_hover', 23 );
	 ...
	 */
	$lightness_selection = apply_filters( '_custom_colors_lightness_selection', 90 );
	...
	$theme_css = '
		...
		.main-navigation .sub-menu > li > a:not(.burger):hover,
		.main-navigation .sub-menu > li > a:not(.burger):focus,
	 ...
	 */
	return apply_filters( 'capezzahill_custom_colors_css', $theme_css, $primary_color, $saturation );
}