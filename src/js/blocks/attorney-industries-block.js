...
registerBlockType( 'ch-block/attorney-industries', {

    // set whatever attributes are needed
    // title
    title: 'Attorney Industry Info',
    // icon
    icon: 'id',
    // category
    ...
    attributes: {
        title: {
            type: 'string',
            source: 'meta',
            meta: 'attorney_industries_title',
        },
        content: {
            type: 'string',
            source: 'meta',
            meta: 'attorney_industries',
        }
    },
    ...
    edit( {setAttributes, attributes}){
        ...
        return( 
            <div className='block-panel'>
                <h2 className="block-label">Industries</h2>
                <RichText
                    tagName="h3"
