(function() {
	...
	// function for adding class to search field if on mobile
	function toggleSearchClass() {
		...
		var search = document.querySelector('.search-submit'),
			isMobile = search.matches('.mobile-search');

		if ( x < 768 &&  !isMobile ){

			search.className += ' mobile-search';

		} else if ( x >= 768 && isMobile ){

			search.className = search.className.replace('mobile-search', '');
